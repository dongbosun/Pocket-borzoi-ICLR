...
MANIFEST ?= /extra/zhanglab0/INDV/dongbos/Pocket-borzoi-ICLR/dataset/manifests/k562_gene_manifest.parquet
...
ref-shards:
	$(PYTHON) scripts/make_teacher_ref_shards.py --manifest $(MANIFEST) --out-dir /extra/zhanglab0/INDV/dongbos/Pocket-borzoi-ICLR/interim/processed/shards/ref_k562 --num-shards 32

submit-ref-teacher:
	$(PYTHON) scripts/submit_sbatch.py --job jobs/teacher_ref_k562_array.sbatch --array 0-31 --export ALL,REPO_ROOT=$(PWD),CONFIG=configs/borzoi_k562_track_100k.yaml,SHARD_DIR=/extra/zhanglab0/INDV/dongbos/Pocket-borzoi-ICLR/interim/processed/shards/ref_k562,CACHE_DIR=/extra/zhanglab0/INDV/dongbos/Pocket-borzoi-ICLR/interim/teacher_cache/ref_k562,FASTA=$(FASTA),ASSETS_CONFIG=$(ASSETS_CONFIG),BATCH_SIZE=4
...
delta-shards:
	$(PYTHON) scripts/make_teacher_delta_shards.py --variants /extra/zhanglab0/INDV/dongbos/Pocket-borzoi-ICLR/dataset/variants/k562_synthetic_snvs.parquet --out-dir /extra/zhanglab0/INDV/dongbos/Pocket-borzoi-ICLR/interim/processed/shards/delta_k562 --num-shards 64

submit-delta-teacher:
	$(PYTHON) scripts/submit_sbatch.py --job jobs/teacher_delta_k562_array.sbatch --array 0-63 --export ALL,REPO_ROOT=$(PWD),CONFIG=configs/borzoi_k562_delta_100k.yaml,SHARD_DIR=/extra/zhanglab0/INDV/dongbos/Pocket-borzoi-ICLR/interim/processed/shards/delta_k562,CACHE_DIR=/extra/zhanglab0/INDV/dongbos/Pocket-borzoi-ICLR/interim/teacher_cache/delta_k562,FASTA=$(FASTA),ASSETS_CONFIG=$(ASSETS_CONFIG),REF_CACHE=/extra/zhanglab0/INDV/dongbos/Pocket-borzoi-ICLR/interim/teacher_cache/k562_ref_labels.parquet,BATCH_SIZE=4
