...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--out-dir", default="/extra/zhanglab1/INDV/dongbos/Pocket-borzoi-ICLR/results/reports/borzoi_task_selection", type=Path)
    parser.add_argument("--out-config", default="configs/borzoi_k562_targets.local.yaml", type=Path)
    parser.add_argument("--out-manifest", default="/extra/zhanglab1/INDV/dongbos/Pocket-borzoi-ICLR/dataset/manifests/k562_selected_targets.json", type=Path)
...
def main() -> None:
    ...
    ref_labels = args.ref_labels or Path(config.get("ref_labels_path", "/extra/zhanglab1/INDV/dongbos/Pocket-borzoi-ICLR/interim/teacher_cache/k562_ref_labels.parquet"))
