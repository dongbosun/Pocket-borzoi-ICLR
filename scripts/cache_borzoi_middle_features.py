...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--layer-report-dir", default="/extra/zhanglab1/INDV/dongbos/Pocket-borzoi-ICLR/results/reports/borzoi_teacher_layers", type=Path)
    parser.add_argument("--layer-name", default="auto")
    parser.add_argument("--folds", nargs="+", type=int, default=[0], choices=[0, 1])
    parser.add_argument("--out-prefix", default="/extra/zhanglab1/INDV/dongbos/Pocket-borzoi-ICLR/interim/teacher_cache/k562_middle", type=Path)
